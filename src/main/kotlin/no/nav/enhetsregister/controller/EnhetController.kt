...
import no.nav.enhetsregister.controller.dto.EnhetDto
...
class EnhetController(private val enhetService: EnhetService) {
	...
	fun hentEnhet(@PathVariable("organisasjonsnummer") organisasjonsnummer: String): EnhetDto {
		...
		return enhetService.hentEnhet(organisasjonsnummer)?.tilDto()
			?: throw NoSuchElementException("Fant ikke enhet med organisasjonsnummer: $organisasjonsnummer")
	}
