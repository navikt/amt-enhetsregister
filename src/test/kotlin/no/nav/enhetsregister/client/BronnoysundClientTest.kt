package no.nav.enhetsregister.client

import no.nav.enhetsregister.client.BronnoysundClient.Companion.mapTilEnhetOppdateringType
...
class BronnoysundClientTest {
	...
	inner class MapTilEnhetOppdateringType {
		...
		@MethodSource("no.nav.enhetsregister.client.BronnoysundClientTest#mapTilEnhetOppdateringTypeSource")
